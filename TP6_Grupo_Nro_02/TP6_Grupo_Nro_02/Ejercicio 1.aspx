...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GrdProductos" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnPageIndexChanging="GrdProductos_PageIndexChanging" OnRowDeleting="GrdProductos_RowDeleting" OnRowEditing="GrdProductos_RowEditing" OnRowCancelingEdit="GrdProductos_RowCancelingEdit" OnRowUpdating="GrdProductos_RowUpdating">
            <Columns>
                <asp:TemplateField HeaderText="Id Producto">
                    <EditItemTemplate>
                        <asp:Label ID="lbl_eit_DProducto" runat="server" Text='<%# Bind("IdProducto") %>'></asp:Label>
                    </EditItemTemplate>
                    <ItemTemplate>
