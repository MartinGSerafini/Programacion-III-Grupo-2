...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txbnombre" runat="server" Width="150px" Height="19px" Style="position: absolute; left: 90px; top: 20px;" MaxLength="20"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Lblclave" runat="server" Text="Clave:" Font-Size="14pt" Style="position: absolute; left: 20px; top: 60px;"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txbnombre0" runat="server" Width="150px" Height="19px" Style="position: absolute; left: 90px; top: 60px;" MaxLength="20" TextMode="Password"></asp:TextBox>
            <br />
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
