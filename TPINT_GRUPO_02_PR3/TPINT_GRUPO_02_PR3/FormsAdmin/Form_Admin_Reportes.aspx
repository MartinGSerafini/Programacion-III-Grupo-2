        ...
        <div class="container">
            ...
            <table align="left" class="auto-style1">
                <tr>
                    <td>&nbsp;</td>
                    <td>Pacientes<br />
                        presentes y ausentes</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Label ID="lblReportePyA1" runat="server"></asp:Label>
                        <br />
                        <asp:Label ID="lblReportePyA2" runat="server"></asp:Label>
                    </td>
                </tr>
            </table>
            &nbsp;<table align="right" class="auto-style1">
                <tr>
                    <td>Especialidades con más y menos turnos agendados</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblReporteEsp1" runat="server"></asp:Label>
                        <br />
                        <asp:Label ID="lblReporteEsp2" runat="server"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <asp:GridView ID="grdEspecialidadesXturnos" runat="server" AllowPaging="True" PageSize="5">
                        </asp:GridView>
                    </td>
                    <td>&nbsp;</td>
                </tr>
