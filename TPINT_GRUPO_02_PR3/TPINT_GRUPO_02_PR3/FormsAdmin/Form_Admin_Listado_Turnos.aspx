    ...
    <div class="wrapper">
        <div class="header">
            ...
            <div class="admin-links">
                <asp:HyperLink ID="hlAgregarMedico" runat="server" NavigateUrl="~/FormsAdmin/Form_Admin_Agregar_Turno.aspx" class="btn-search">AGREGAR TRUNO</asp:HyperLink>
                <asp:HyperLink ID="hlListadoMedicos" runat="server" NavigateUrl="~/FormsAdmin/Form_Admin_Listado_Turnos.aspx" class="btn-search">LISTAR TURNOS</asp:HyperLink>
            </div>
            <div class="user-info">
...
<div class="container">
    <table align="center">
        <tr>
            <td style="font-weight: bold;font-size: 40px" class="auto-style8">Administrador de Turnos<br/>
        </td>
        </tr>
    </table>
    <table align="center">
        <tr>
            ...
            <td class="auto-style63">
                <asp:Button ID="btnBuscar" CssClass="btn-search" runat="server" Text="Buscar" />
            </td>
        ...
        <asp:GridView ID="grdListadoTurnoss" runat="server" AutoGenerateColumns="False">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Medico">
                    <ItemTemplate>
                        <asp:Label ID="lbl_it_Medico" runat="server" Text='<%# Bind("NOMBRE_MED") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
