        ...
        <div class="wrapper">
            <div class="header">
                ...
                <div class="admin-links">
                    <asp:HyperLink ID="hlAgregarTurno" runat="server" NavigateUrl="~/FormsAdmin/Form_Admin_Agregar_Turno.aspx" CssClass="btn-search">AGREGAR TURNO</asp:HyperLink>
                    <asp:HyperLink ID="hlListadoTurnos" runat="server" NavigateUrl="~/FormsAdmin/Form_Admin_Listado_Turnos.aspx" CssClass="btn-search">LISTAR TURNOS</asp:HyperLink>
                </div>
                <div class="user-info">
            ...
            <div class="container">
                <table align="center">
                    <tr>
                        <td style="font-weight: bold;font-size: 40px" class="auto-style2">Cargar turno<br />
                            <br/>
                        </td>
                    </tr>
                </table>
                <table align="center" class="auto-style10">
                    ...
                    <tr>
                        ...
                        <td class="auto-style9" style="width: 50%;">
                            <asp:DropDownList ID="ddlEspecialidad" runat="server" CssClass="dropdown-filter" Height="21px" Width="222px" ValidationGroup="VG1" OnSelectedIndexChanged="ddlEspecialidad_SelectedIndexChanged" AutoPostBack="True">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:DropDownList ID="ddlMedico" runat="server" Height="23px" CssClass="dropdown-filter" Width="222px" AutoPostBack="True" ValidationGroup="VG1" OnSelectedIndexChanged="ddlMedico_SelectedIndexChanged">
                    ...
                    <tr>
                        <td colspan="2" class="auto-style1">
                            <asp:RequiredFieldValidator ID="RfvMedico" runat="server" ControlToValidate="ddlMedico" CssClass="validator-message" InitialValue="-1" ValidationGroup="VG1" ForeColor="#FFC2C2" Display="Dynamic">Seleccione una Medico</asp:RequiredFieldValidator>
                            <br />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style9" style="width: 50%;">
                            <asp:DropDownList ID="ddlDia" runat="server" Height="23px" Width="222px" ValidationGroup="VG1" AutoPostBack="True">
                                <asp:ListItem Value="-1">--Seleccione un  día--</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="auto-style1">
                            <asp:RequiredFieldValidator ID="RfvDia" runat="server" ControlToValidate="ddlDia" CssClass="validator-message" InitialValue="-1" ValidationGroup="VG1" ForeColor="#FFC2C2" Display="Dynamic">Seleccione un Día</asp:RequiredFieldValidator>
                            <br />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:DropDownList ID="ddlHora" runat="server" Height="23px" Width="222px" ValidationGroup="VG1" AutoPostBack="True">
                    ...
                    <tr>
                        <td colspan="2" class="validator">
                            <asp:RequiredFieldValidator ID="RfvHora" runat="server" ControlToValidate="ddlHora" CssClass="validator-message" ValidationGroup="VG1" ForeColor="#FFC2C2" Display="Dynamic">Ingrese una Fecha</asp:RequiredFieldValidator>
                            <br />
                        </td>
                    </tr>
                ...
                <table align="center" class="admin-links">
                    <tr>
                        ...
                        <td class="link">
                            <asp:Button ID="BtnAgregar" runat="server" Text="Crear Turno" CssClass="btn-search" Width="121px" ValidationGroup="VG1" OnClick="BtnAgregar_Click" Height="40px" OnClientClick="return ConfirmarIngreso();" />
                        </td>
                        <script type="text/javascript">
                            function ConfirmarIngreso() {
                                var isValid = Page_ClientValidate("VG1");
                                if (isValid) {
                                    var resultado = confirm("¿Esta seguro de querer cargar el turno en el sistema?");
                                    if (resultado) {
                                        return true;
                                    } else {
                                        return false;
