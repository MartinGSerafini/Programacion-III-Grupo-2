...
<body>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlFiltros" runat="server" CssClass="dropdown-filter">
                ...
                <asp:ListItem Value="P.TELEFONO_PAS">TELÉFONO</asp:ListItem>
            </asp:DropDownList>
        </td>
    </tr>
</table>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Nombre">
            <EditItemTemplate>
                <asp:TextBox ID="txtNombre" CssClass="input-style" runat="server" Text='<%# Bind("NOMBRE_PAS") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Apellido">
            <EditItemTemplate>
                <asp:TextBox ID="txtApellido" CssClass="input-style" runat="server" Text='<%# Bind("APELLIDO_PAS") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Sexo">
            <EditItemTemplate>
                <asp:DropDownList ID="ddlSexo" CssClass="input-style" runat="server" SelectedValue='<%# Bind("SEXO_PAS") %>'>
        ...
        <asp:TemplateField HeaderText="Nacionalidad">
            <EditItemTemplate>
                <asp:TextBox ID="txtNacionalidad" CssClass="input-style" runat="server" Text='<%# Bind("NACIONALIDAD_PAS") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Dirección">
            <EditItemTemplate>
                <asp:TextBox ID="txtDireccion" CssClass="input-style" runat="server" Text='<%# Bind("DIRECCION_PAS") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Email">
            <EditItemTemplate>
                <asp:TextBox ID="txtEmail" CssClass="input-style" runat="server" Text='<%# Bind("EMAIL_PAS") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Telefono">
            <EditItemTemplate>
                <asp:TextBox ID="txtTelefono" CssClass="input-style" runat="server" Text='<%# Bind("TELEFONO_PAS") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
       ...
       <asp:TemplateField>
            ...
            <EditItemTemplate>
                ...
                <asp:Button ID="btnCancelar" runat="server" CommandName="Cancel" Text="&#10060;" />
            </EditItemTemplate>
        </asp:TemplateField>
