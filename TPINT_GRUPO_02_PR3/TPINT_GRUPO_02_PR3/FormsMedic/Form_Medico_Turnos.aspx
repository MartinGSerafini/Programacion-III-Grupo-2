    ...
    <form id="form1" runat="server">
            <div class="wrapper">
             ...
             <div class="container">
                 <table align="center">
                     <tr>
                         <td style="font-weight: bold;font-size: 40px" class="auto-style7">Mis turnos</td>
                     </tr>
                 </table>
             ...
             <tr>
                ...
                <td class="auto-style65">
                    <asp:DropDownList ID="ddlFiltros" runat="server" CssClass="dropdown-filter">
                        <asp:ListItem Value="-1">SELECCIONE UNA CATEGORIA</asp:ListItem>
                        ...
                        <asp:ListItem Value="T.FECHA_TUR">FECHA</asp:ListItem>
                        <asp:ListItem Value="T.HORA_TUR">HORARIO</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
            <br />
            <asp:GridView ID="grdListadoTurnos" runat="server" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre y Apellido">
                        <ItemTemplate>
                            <asp:Label ID="lbl_it_nombre" runat="server" Text='<%# Bind("NombreApellido") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Horario">
                        <ItemTemplate>
                            <asp:Label ID="lbl_it_horario" runat="server" Text='<%# Bind("HORA_TUR") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Asistencia ">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddl_it_Asistencias" runat="server" Height="22px" Width="175px">
                                <asp:ListItem Value="-1">SELECCIONAR OPCIÓN</asp:ListItem>
                    ...
                    <asp:TemplateField HeaderText="Observaciones">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_it_Observaciones" runat="server" Height="18px" Width="208px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btn_it_Guardar" runat="server" Text="Guardar" OnClick="btnGuardar_Click" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
