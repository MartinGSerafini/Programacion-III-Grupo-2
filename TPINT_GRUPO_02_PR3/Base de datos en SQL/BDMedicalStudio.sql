...
CREATE TABLE HORARIO_ATENCION (
    ...
    FK_ID_MEDICO_HDA INT,
    DIA_HDA VARCHAR(20),
    HORA_INICIO_HDA TIME,
    HORA_FIN_HDA TIME,
    FOREIGN KEY (FK_ID_MEDICO_HDA) REFERENCES MEDICOS(ID_MEDICO_MED)
);
GO
...
@DNIPACIENTE char(8), @LOCALIDAD varchar(30), @PROVINCIA varchar(30), @NOMBRE varchar(30), @APELLIDO varchar(30), @SEXO char(1), @NACIONALIDAD VARCHAR(30), @NACIEMIENTO Date,
@DIRECCION varchar(40), @EMAIL varchar(40), @TELEFONO VARCHAR(20)
AS
UPDATE PACIENTES SET FK_ID_LOCALIDAD_PAS = (SELECT ID_LOCALIDAD_LOC FROM LOCALIDADES WHERE NOMBRE_LOC = @LOCALIDAD), FK_ID_PROVINCIA_PAS = 
(SELECT ID_PROVINCIA_PRO FROM PROVINCIAS WHERE NOMBRE_PRO = @PROVINCIA), NOMBRE_PAS = @NOMBRE, APELLIDO_PAS = @APELLIDO, SEXO_PAS = @SEXO, NACIONALIDAD_PAS = @NACIONALIDAD,
NACIMIENTO_PAS = @NACIEMIENTO ,DIRECCION_PAS = @DIRECCION, EMAIL_PAS = @EMAIL, TELEFONO_PAS = @TELEFONO
WHERE DNI_PAS = @DNIPACIENTE
RETURN
GO